				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><svg class="glyph stroked male user ">
							...
							<a href="<?php echo base_url(); ?>bagian_departemen/add" style="text-decoration:none">Tambah Data Divisi</a>
						</div>
							...
							<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
									<tr>
										...
										<th data-field="bagian" data-sortable="true">Divisi</th>
										<th>Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 0;
									foreach ($databagiandepartemen as $row) : $no++; ?>
										<tr>
