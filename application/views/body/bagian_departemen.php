...
<a href="<?php echo base_url();?>bagian_departemen/add" style="text-decoration:none">Tambah Data Bagian Departemen</a></div>
		...
		<?php echo $this->session->flashdata("msg");?>
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="id" data-sortable="true">Departemen</th>
						        <th data-field="bagian" data-sortable="true">Bagian Departemen</th>
						         <th >Aksi</th>
						    </tr>
                            </thead>
                            <tbody>
                           <?php $no = 0; foreach($databagiandepartemen as $row) : $no++;?>
						     <tr>
