...
<a href="<?php echo base_url();?>kategori/add" style="text-decoration:none">Tambah Data Kategori</a></div>
		...
		<?php echo $this->session->flashdata("msg");?>
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            ...
                            <tbody>
                           <?php $no = 0; foreach($datakategori as $row) : $no++;?>
						     <tr>
						        <td data-field="no" width="10px"><?php echo $no;?></td>
						        <td data-field="id"><?php echo $row->nama_kategori;?></td>
						         <td> 
<a class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>kategori/edit/<?php echo $row->id_kategori;?>"><span class="glyphicon glyphicon-edit" ></span></a>
